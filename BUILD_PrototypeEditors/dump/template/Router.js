...
jQuery.sap.declare( 'sap.norman.Router' );

sap.ui.core.routing.Router.extend( 'sap.norman.Router', {

	constructor : function () {
		sap.ui.core.routing.Router.apply( this, arguments );
		this._oRouteMatchedHandler = new sap.m.routing.RouteMatchedHandler( this );
		this._oRouteMatchedHandler.setCloseDialogs(true);
	},
	 ...
	 *            <li> targetViewName : the fully qualified name of the view you
	 *            want to navigate to.</li>
	 *            <li> targetViewType : the viewtype eg: XML</li>
	 *            <li> isMaster : default is false, true if the view should be
	 *            put in the master</li>
	 *            <li> transition : default is 'show', the navigation transition</li>
	 *            <li> data : the data passed to the navContainers livecycle
	 *            events</li>
	 *            </ul>
	 */
