...
var serviceLogger = commonServer.logging.createLogger('SharedWorkspace-server');

var serviceFactories = {
    PrototypeService: require('./prototype'),
    SnapshotService: require('./snapshot'),
    ArtifactService: require('./artifact'),
    SwRegistryService: require('./registry'),
    SwProcessing: require('./contentprocessing')
};
