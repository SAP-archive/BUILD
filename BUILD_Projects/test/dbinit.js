...
server.start()
    .then(function () {
        ...
        initPromises.push(Promise.invoke(uiCatalog, 'initializeDb'));
        initPromises.push(Promise.invoke(uiCatalog, 'initializeLibrary'));
        initPromises.push(Promise.invoke(uiCatalog, 'storeOpenUI5Canvas'));
