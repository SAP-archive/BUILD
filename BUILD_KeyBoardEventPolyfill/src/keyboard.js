var applyPolyfill = function(global) {
    ...
    if ('KeyboardEvent' in global && 'defineProperty' in Object) {
        (function() {
            ...
            define(global.KeyboardEvent.prototype, 'code', {
                get: function() {
            ...
            if ('key' in global.KeyboardEvent.prototype) {
                var desc = Object.getOwnPropertyDescriptor(global.KeyboardEvent.prototype, 'key');
                Object.defineProperty(global.KeyboardEvent.prototype, 'key', {
                    get: function() {
            ...
            define(global.KeyboardEvent.prototype, 'key', {
                get: function() {
                    var keyInfo = keyInfoForEvent(this);
            ...
            define(global.KeyboardEvent.prototype, 'location', {
                get: function() {
                    var keyInfo = keyInfoForEvent(this);
            ...
            define(global.KeyboardEvent.prototype, 'locale', {
                get: function() {
                    return '';
                }
            });
