...
**Note**:  In order to optimize the chances for your submissions to pass the review stage, we recommend you review  [Contribution Guidelines](https://github.wdf.sap.corp/Norman/Norman/blob/master/Contributing.md).
